...
$cfg['blowfish_secret']					= '.cncpIy95\\Wg#:}w-j+\"-@$Jewwr\"ng$' ;  // i.e. '$b~`lnkwm>^^jNUEE;(4xB$L\'b?."\'o9' 
...
$cfg['PmaAbsoluteUri'] 					= '/wp-content/plugins/wp-phpmyadmin-extension/lib/phpMyAdmin_Uq1nB5rshAdtIuVlMzT0798/';			//used, if different directory by htaccess ; or parse_url($GLOBALS['PMA_PHP_SELF']);
